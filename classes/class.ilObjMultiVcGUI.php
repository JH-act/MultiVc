...
//            if(null !==  $this->object->hasScheduledMeetingsCollision($this->ref_id, $relateMeeting['start'], $relateMeeting['end'])) {
    ...
    public function afterSave(ilObject $newObj): void
    {
        ...
        $newObj->createRoom((int) $form->getInput("online"), $form->getInput("conn_id"));
     ...
     */
    public function formItem(string $item)
    {
     ...
     */
    public function getUiCompMsgBox(string $type = 'info', string $msg = '', bool $rendered = true)
    {
...
//                $this->showContentWindowWebex(ilMultiVcConfig::getInstance($this->object->getConnId())->getSvrPublicUrl(), $data); //before 8
    ...
    {
        require_once(dirname(__FILE__) . '/class.ilApiTeams.php');
        try {
...
//        $backUrl = ILIAS_HTTP_PATH . '/' . substr($rqUri, strpos($rqUri, 'ilias.php')) . '&startWEBEX=10';
     ...
     * @throws Exception
     */
    private function getJoinContent($vcObj): string
    {
